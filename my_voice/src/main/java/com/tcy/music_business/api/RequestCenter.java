package com.tcy.music_business.api;
...
import com.tcy.lib_network.okhttp.request.RequestParams;
...
public class RequestCenter {
    ...
    static class HttpConstants {
        ...
        private static final String ROOT_URL = "http://39.97.122.129";//新申请的python服务器
    ...
    public static void requestFriendData(DisposeDataListener listener) {
        getRequest(HttpConstants.HOME_FRIEND,
                null,
                listener,
